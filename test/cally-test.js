...
describe('Cally', function() {
    it("Can not find day of week date", function() {
        var appt;
        appt = new Cally("MOOONNNNNDDDAAAAYYYY", new Date());
        assert(!appt.datefound);
    });

    it("Day of week - Can find monday, tuesday, wednesday, thursday, friday, saturday, sunday", function() {
    ...
    it("Day of week - Can find mon,tues,wed,thurs,fri,sat,sun", function() {
        var appt;
    ...
    it("Day of week - Can find next mon,tues,wed,thurs,fri,sat,sun", function() {
        var appt;
    ...
    it("Day of week - Can ignore day of week embedded in other words", function() {
    ...
    it("Day of week - Can find a subject before a day of the week", function() {
        var appt;
        appt = new Cally("Meet John Monday", new Date());
    ...
    it("Day of week - Can find subject when there is a keyword prior to day of week", function() {
        var appt;
    ...
    it("Day of week - can find a subject before a day of the week with comma", function() {
        var appt;
        appt = new Cally("Meet John, Monday", new Date());
        assert(appt.subjectfound);
        assert(appt.datefound);
